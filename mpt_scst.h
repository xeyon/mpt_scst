...
#define NUM_SGES	256
#define NUM_CHAINS	(NUM_SGES/4)	/* since we only use 64 bytes in a request frame,
									there would be only 4 sges(12 bytes each and 12 byte
									chain descriptor) in one chain. */
